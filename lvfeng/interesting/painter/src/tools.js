...
tools = [{
	name: "自由选择",
	description: "选择图片的自由形式部分来移动、复制或编辑。",
	...
	name: "选择",
	description: "选择图片的矩形部分来移动、复制或编辑。",
	cursor: ["precise", [16, 16], "crosshair"],
	passive: true,
	drag_start_x: 0,
	drag_start_y: 0,
	...
	name: "橡皮擦/色彩橡皮擦",
	description: "使用选定的橡皮擦形状擦除图片的一部分。",
	cursor: ["precise", [16, 16], "crosshair"],
